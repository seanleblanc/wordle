...
(setq wordle--word-list
      '(
        "aback" "abbey" "abled" "abide" "abode" "about" "abuse" "abyss" "acids" "acred" "acres" "acted"
        ...
        "amend" "amino" "amity" "among" "amour" "ample" "angle" "ankle" "anode"
        ...
        "basin" "bates" "baths" "baton" "bayou" "beady" "beams" "beans" "beard" "bears"
        ...
        "blown" "blows" "blurb" "blush"
        "boats" "board" "boing" "bonus" "books" "bowel"
        "bolts" "bombs" "bones" "boost" "booth" "booty" "boron" "bosom" "bowls" "boxes"
        "brace" "brach" "brain" "brand" "brash" "brass" "brats" "brawl" "bread"
        "break" "breed" "bribe" "brick" "bride" "brief" "brine" "bring" "brink" "briny"
        "brisk" "broad" "broil" "broke" "brood" "brook" "broom" "broth" "brows" "brunt" 
        "built" "bulbs" "bulky" "burns" "burnt" "buses" "busts" "butte" "bytes"
        ...
        "clean" "clear" "click" "climb" "cling" "clone" "close" "cloth" "clots"
        ...
        "crawl" "crazy" "creak" "credo" "creek" "crept" "crest" "crews" "cries" "crime" "crisp"
        ...
        "germs" "ghost" "ghoul" "girls" "girth" "given" "gives" "glare"
        "glass" "glaze" "glide" "gloat" "gloom" "glory" "gloss"
        "glove" "glued" "glyph" "grips" "gross" "going" "gorge" "goyim" "grail"
        "grain" "grand" "grant" "grass" "grate" "grave" "gravy" "graze"
        ...
        "lunch" "lunge" "lungs" "lures" "lying" "lyric"
        ...
        "nance" "nasal" "nasty" "natal" "navel" "nears" "neath" "necks" "needs"
        ...
        "photo" "picks" "picky" "piece" "piers" "piety" "pines" "piled"
        "piler" "piles" "pills" "pilot" "pinch" "pinto" "pipes" "pithy" "pivot" "pixel" "pixie" "pizza" "plaid"
        ...
        "shout" "shown" "showy" "shrug" "shunt" "shush" "siege" "sighs" "sight" "silky"
        ...
        "timid" "tints" "tired" "tires" "titan" "tithe" "title" "today" "toils" "token" "tombs" "tomes"
        ...
        "udder" "ulcer" "undue" "union" "unite" "until" "upset" "urged"
